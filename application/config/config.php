...
|
*/
$config['base_url'] = 'http://test.biblioteca.mx/';
...
$config['sess_time_to_update']    = 300; */
$fp = fopen(getcwd()."/csv/datos.txt", "r");
while(!feof($fp)) {
	$datos = fgets($fp);
}
fclose($fp);
//guardar con sha1 y md5
$config['user']=explode(',', $datos)[0];
$config['pass']=explode(',', $datos)[1];
$config['dbpass']='1234';
$config['dbserver']='localhost';
$config['dbname']='bibliofin';
$config['dbuser']='root';
