...
Class Reserva_model extends CI_Model
{
  ...
  public function construct() {
    ...
    function get_reservas($cuenta){
      ...
      $query=$this->db->query("select idreserva, titulo,ejemplar.nadqui,".$mesv.",".$namediav.",day(".$fechaentrega.") as dia,year(fecha) as anio,fecha
     ...
     function eliminarreserva($id){
      ...
      function obtener_datos($inicio=0,$cantidad=10,$nadqui=false,$cuenta=false,$tipo=""){
        ...
        $query=$this->db->query("select idreserva,ub.cuentausuario as cuenta,pnombre,
